...
import com.globant.webProject.service.IPhoneService;
...
public class PhoneController {
    ...
    public @ResponseBody String addNewPhone (@RequestBody Phone phone) {
        phoneService.createPhone(phone);
        return "Saved phone "  + phone.getId();
    }

    @PutMapping(path="/modifyPhone/{phone_id}")
    public @ResponseBody String modifyPhone (@RequestBody  Phone phone, @PathVariable(value="phone_id") int phone_id){
